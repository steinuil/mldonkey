...
val bitstring_of_bytes : bytes -> bitstring
(** [bitstring_of_bytes str] creates a bitstring
    of length [Bytes.length str * 8] (bits) containing the
    bits in [str].
...
val bytes_of_bitstring : bitstring -> bytes
...
external extract_fastpath_int16_be_unsigned : bytes -> int -> int = "ocaml_bitstring_extract_fastpath_int16_be_unsigned" [@@noalloc]

external extract_fastpath_int16_le_unsigned : bytes -> int -> int = "ocaml_bitstring_extract_fastpath_int16_le_unsigned" [@@noalloc]

external extract_fastpath_int16_ne_unsigned : bytes -> int -> int = "ocaml_bitstring_extract_fastpath_int16_ne_unsigned" [@@noalloc]

external extract_fastpath_int16_be_signed : bytes -> int -> int = "ocaml_bitstring_extract_fastpath_int16_be_signed" [@@noalloc]

external extract_fastpath_int16_le_signed : bytes -> int -> int = "ocaml_bitstring_extract_fastpath_int16_le_signed" [@@noalloc]

external extract_fastpath_int16_ne_signed : bytes -> int -> int = "ocaml_bitstring_extract_fastpath_int16_ne_signed" [@@noalloc]
...
external extract_fastpath_int32_be_unsigned : bytes -> int -> int32 -> int32 = "ocaml_bitstring_extract_fastpath_int32_be_unsigned" [@@noalloc]

external extract_fastpath_int32_le_unsigned : bytes -> int -> int32 -> int32 = "ocaml_bitstring_extract_fastpath_int32_le_unsigned" [@@noalloc]

external extract_fastpath_int32_ne_unsigned : bytes -> int -> int32 -> int32 = "ocaml_bitstring_extract_fastpath_int32_ne_unsigned" [@@noalloc]

external extract_fastpath_int32_be_signed : bytes -> int -> int32 -> int32 = "ocaml_bitstring_extract_fastpath_int32_be_signed" [@@noalloc]

external extract_fastpath_int32_le_signed : bytes -> int -> int32 -> int32 = "ocaml_bitstring_extract_fastpath_int32_le_signed" [@@noalloc]

external extract_fastpath_int32_ne_signed : bytes -> int -> int32 -> int32 = "ocaml_bitstring_extract_fastpath_int32_ne_signed" [@@noalloc]
...
external extract_fastpath_int64_be_unsigned : bytes -> int -> int64 -> int64 = "ocaml_bitstring_extract_fastpath_int64_be_unsigned" [@@noalloc]

external extract_fastpath_int64_le_unsigned : bytes -> int -> int64 -> int64 = "ocaml_bitstring_extract_fastpath_int64_le_unsigned" [@@noalloc]

external extract_fastpath_int64_ne_unsigned : bytes -> int -> int64 -> int64 = "ocaml_bitstring_extract_fastpath_int64_ne_unsigned" [@@noalloc]

external extract_fastpath_int64_be_signed : bytes -> int -> int64 -> int64 = "ocaml_bitstring_extract_fastpath_int64_be_signed" [@@noalloc]

external extract_fastpath_int64_le_signed : bytes -> int -> int64 -> int64 = "ocaml_bitstring_extract_fastpath_int64_le_signed" [@@noalloc]

external extract_fastpath_int64_ne_signed : bytes -> int -> int64 -> int64 = "ocaml_bitstring_extract_fastpath_int64_ne_signed" [@@noalloc]
