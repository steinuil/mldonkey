...
val html_mods_table_header :
  Buffer.t ->
  ?total:string ->
  string ->
  string ->
  (sort_kind * string * string * string) list ->
  unit

val html_mods_table_header_colspan :
  Buffer.t ->
  ?total:string ->
  string ->
  string ->
...
val html_mods_table_no_header :
  Buffer.t -> string -> string -> (string * string * string) list -> unit

val html_mods_table_one_row :
  Buffer.t -> string -> string -> (string * string * string) list -> unit

val html_mods_table_one_col :
  Buffer.t -> string -> string -> (string * string * string) list -> unit
