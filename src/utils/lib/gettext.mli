...
val text_option : 'a arrow -> ('a, unit, string) format Options.option_class
...
module T : sig
  ...
  val option : 'a arrow -> ('a, unit, string) format Options.option_class

  val boption : 'a arrow -> ('a, Buffer.t, unit) format Options.option_class
end

val gettext : ('a, unit, string) format Options.option_record -> 'a

val buftext :
  Buffer.t -> ('a, Buffer.t, unit) format Options.option_record -> 'a
