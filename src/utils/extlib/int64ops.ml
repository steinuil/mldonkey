...
let int64_of_uint32 v = and64 (Int64.of_int32 v) bits32_64
...
let round_down64 x y = (x // y) ** y

let round_up64 x y = (Int64.pred (x ++ y) // y) ** y
...
let int64_to_human_readable size =
  ...
  then Printf.sprintf "%5.1f%s" (Int64.to_float size /. 1048576.) "mb"
