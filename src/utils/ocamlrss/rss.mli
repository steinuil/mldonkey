...
type category = { mutable cat_name : string; mutable cat_domain : url option }
...
type source = { mutable src_name : string; mutable src_url : url }
...
type channel = {
  ...
  mutable ch_last_build_date : date option;
      (** When the channel was last built *)
